...
import { AiOutlineSend, AiFillGithub, AiFillHeart , AiOutlineCopyright} from 'react-icons/ai';
...
const Footer = () => {
  return (
    ...
    <VStack>
      ...
      <Text fontWeight={'medium'} display={'flex'} gap={'2'} justifyContent={'center'} alignItems={'center'} >Developed with  <AiFillHeart color='red' /> by <a href='https://github.com/rajeshiitk' target="blank" ><Text  _hover={{color : "green"}} color={'purple'} >rajeshiitk</Text> </a>  </Text>
      <Text opacity={'0.5'} display={'flex'}  justifyContent={'center'} alignItems={'center'}> <AiOutlineCopyright /> Sikke-baaz 2023. No Rights Reserved.</Text>
      </VStack>
    </Box>
  )
}
